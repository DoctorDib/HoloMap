...
class Calibration_Module(ModuleHelper):
    def __init__(self, memory_name: str, parent_module_name: str, image_shape, app: Flask = None, output: Queue = None, 
                 shared_state: multiprocessing.managers.SyncManager.dict = None,  module_path: str = ""):
        """
        ...
        super().__init__("Calibration", parent_module_name, parent_memory_name=memory_name, app=app, output=output, shared_state=shared_state, module_path=module_path)
