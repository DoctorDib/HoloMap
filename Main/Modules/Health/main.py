...
class Health_Module(ModuleHelper):
    def __init__(self, memory_name: str = None, parent_module_name: str = None, memory_size: int = None,
        ...
        super().__init__("Health", parent_module_name, parent_memory_name=memory_name, app=app, output=output, shared_state=shared_state, module_path=module_path)
    ...
    def run(self):
        ...
        try:
            while not self.shutdown_event.is_set():
                ...
                #        to send info when not in debug mode.
